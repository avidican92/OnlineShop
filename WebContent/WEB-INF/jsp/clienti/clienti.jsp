...
<c:forEach items="${model.clienti}" var="c">
<tr>
 <td><c:out value="${c.id}"/></td>
 <td><c:out value="${c.nume}"/></td>
 <td><c:out value= "${c.adresa}"/></td>
 <td><c:out value= "${c.oras}"/></td>
 <td><c:out value= "${c.codPostal}"/></td>
 <td><c:out value= "${c.email}"/></td>
 <td><c:out value= "${c.telefon}"/></td>
 <td><a href="./clientiEdit/${c.id}" class="far fa-edit"></a>
      |     <a href="deleteClienti/${c.id}" onclick="return confirm('Sunteti sigur ca doriti sa stergeti aceasta intrare?');"  class="fa fa-trash-o"></a></td>
 </tr>
 <br/>
</c:forEach>
</table>
