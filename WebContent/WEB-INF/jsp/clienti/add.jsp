...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a class="active" href="./clienti.htm">Clienti</a>
...
<form:form action="./addClienti.htm" commandName="clientiForm" 
			method="post">
	...
	<form:input type="text" path="adresa" name="id"/>
       ...
       <label for="fname">Oras</label>
    <form:input type="text" path="oras" name="id"/>
    
    <label for="fname">codPostal</label> <a href="#" data-toggle="tooltip" title="Introduce-ti dupa formatul: L-V: 8-22 | S: 10-20 | D: inchis">&#9432;</a>
    <form:input type="text" path="codPostal" name="id"/>

	<label for="fname">Email</label>
    <form:input type="text" path="email" name="id"/>
