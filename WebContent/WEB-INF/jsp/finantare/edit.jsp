...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a class="active" href="./finantare.htm">Finantare</a>
  </div>
</div>
...
<form:form action="${pageContext.request.contextPath}/editFinantare.htm" commandName="finantareForm" 
			method="post">
    ...
    <form:input type="text" path="nume" name="id"/>
       ...
       <label for="fname">Banca Emitenta</label>
    <form:input type="text" path="bancaEmitenta" name="id"/>
    
    <label for="fname">Nr. Rate</label> <a href="#" data-toggle="tooltip" title="Introduce-ti dupa formatul: L-V: 8-22 | S: 10-20 | D: inchis">&#9432;</a>
    <form:input type="text" path="nrRate" name="id"/>

<label for="categorie">Categorie Produse</label>
    <select id="categorieProduse" name="categorieProduse">
    <option value="Toate">Toate</option>
 	...
 	<label for="fname">Campanie? </label>  
	<input type="checkbox" id="campanie" name="campanie" value="1"><br>
