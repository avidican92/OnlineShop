...
<form:form action="${pageContext.request.contextPath}/editBranduri.htm" commandName="branduriForm" 
			method="post">
...
<label for="categorie">Categorie</label>
    ...
    <form:input type="text" path="website" name="id"/>


    <label for="fname">Tara de provenienta</label>
    <form:input type="text" path="taraProvenienta" name="id"/>
...
Tara De Provenienta <form:input path="taraProvenienta"/>
<input type=submit value="Salveaza"/> --%>
</form:form>
</div>
</body>
